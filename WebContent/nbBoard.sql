...
VALUES
(1, '밥맛있는집직원', '집에서 만든 맛있는 밥', '오늘은 집에서 간단히 미역국과 소고기 무국을 만들어 먹었어요. 맛있었어요~', 'images/bap.jpg', '서울 강남구 서초동', TO_TIMESTAMP('2024-07-12 10:30:00', 'YYYY-MM-DD HH24:MI:SS'), 0, 0, 0);
INSERT INTO nbBoard (idx, nickName, title, content, img, region, writeDate, readCount, likeCount, recommendCount)
VALUES
...
INSERT INTO nbBoard (idx, nickName, title, content, img, region, writeDate, readCount, likeCount, recommendCount)
VALUES
(4, '여행매니아', '최근 가본 여행지', '최근에 다녀온 여행지는 제주도였어요. 제주의 아름다운 풍경과 맛있는 음식들이 정말 멋있었어요!', 'images/travel.jpg', '제주 서귀포시 대정읍', TO_TIMESTAMP('2024-07-10 09:00:00', 'YYYY-MM-DD HH24:MI:SS'), 0, 0, 0);
INSERT INTO nbBoard (idx, nickName, title, content, img, region, writeDate, readCount, likeCount, recommendCount)
VALUES
...
INSERT INTO nbBoard (idx, nickName, title, content, img, region, writeDate, readCount, likeCount, recommendCount)
VALUES
(7, '음식하러가자', '오늘 점심 추천', '점심으로 먹은 짜장면 맛집 추천드려요. 양도 푸짐하고 맛도 괜찮았어요.', 'images/food.jpg', '서울 중구 법정동', TO_TIMESTAMP('2024-07-07 13:20:00', 'YYYY-MM-DD HH24:MI:SS'), 0, 0, 0);
INSERT INTO nbBoard (idx, nickName, title, content, img, region, writeDate, readCount, likeCount, recommendCount)
VALUES
...
INSERT INTO nbBoard (idx, nickName, title, content, img, region, writeDate, readCount, likeCount, recommendCount)
VALUES
(9, '축구하는 고래', '오늘의 축구 경기 후기', '오늘 친구들과 함께 축구를 즐겼어요. 저희 팀이 승리해서 기분이 좋네요.', 'images/soccer.jpg', '서울 송파구 석촌동', TO_TIMESTAMP('2024-07-05 19:45:00', 'YYYY-MM-DD HH24:MI:SS'), 37, 22, 9);
INSERT INTO nbBoard (idx, nickName, title, content, img, region, writeDate, readCount, likeCount, recommendCount)
VALUES
